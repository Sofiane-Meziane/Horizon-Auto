...
import dao.ConsultationCandidatsDao;
...
public class ConsultationCandidatsController {
    ...
    private void loadCandidatsData() {
        ConsultationCandidatsDao dao = new ConsultationCandidatsDao();
        elevesList = FXCollections.observableArrayList(dao.getAllEleves());
